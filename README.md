...
|---|----------|---------|-------------|--------|
| 00 | [`python/features_engineer.ipynb`](https://github.com/mojahid1252/Retailrocket-Ecommerce-Business-Analysis/blob/7cbcb47803a9118101dc0a69cefb2b04a61fd0b3/Notebook%2000%20Feature%20Engineering.ipynb) | Create 35+ engineered features used across all notebooks | Session-level features, user-level features, item-level features, time-based features, behavioral signal features | [`features_engineer.csv`]() |
